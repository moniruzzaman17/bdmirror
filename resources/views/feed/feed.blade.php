...
<div class="common-structure">
    <header class="main-header u-flex">
        <div class="start u-flex">
            <a class="logo">
                <img src="{{ asset('img/logo.png') }}" class="login-logo" alt=""></a>
    ...
    <nav class="user-nav">
        <ul class="user-nav-list u-flex">
            <li class="user-nav-item">
                <a class="user">
                    <img class="user-image" src="{{ asset('img/moon.jpg') }}" height="28" width="28" alt="">
                    <span class="user-name">Moon</span>
                </a>
            </li>
            <li class="user-nav-item">
        ...
        <ul class="main-feed-list">
            <li class="main-feed-item">
                <article class="common-post">
                    <header class="common-post-header u-flex">
                        <img src="{{ asset('img/moon.jpg') }}" class="user-image" width="40" height="40" alt="">
                        <div class="common-post-info">
                            <div class="user-and-group u-flex">
                                <a href="https://www.facebook.com/eladsc" target="_blank">Md. Moniruzzaman</a>
                            </div>
                    ...
                    <div class="common-post-content common-content">
                        ...
                        <a class="embed-content" href="https://www.youtube.com/watch?v=TmfbHPObs-0" target="_blank">
                            ...
                            <div class="embed-content-text">
                                ...
                                <h2 class="embed-content-title">How to Create Pure CSS Games - by Md. Moniruzzaman</h2>
            ...
            <li class="main-feed-item">
                <article class="common-post">
                    ...
                    <div class="common-post-content common-content">
                        ...
                        <p>In Md. Moniruzzaman's first article on CSS Basics Things, He let developers know the CSS definitions of text typography, and actually understand what and how to control it.</p>
            ...
            <li class="main-feed-item">
                <article class="common-post">
                    ...
                    <div class="common-post-content common-content">
                        <p>Md. Moniruzzaman explains why the world needs CSS developers.</p>
